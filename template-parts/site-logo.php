<?php
/**
 * UNMASK Site Logo Override
 *
 * Shows UNMASK wordlogo for logged-out visitors.
 * Falls back to parent theme behavior for logged-in users.
 *
 * @package UNMASK
 */
...
// For logged-out visitors: No logo in header (homepage has its own branding)
if (!is_user_logged_in()) {
    return;
}

// For logged-in users: Use default BuddyBoss logo behavior
// (Copied from parent theme template-parts/site-logo.php)
